  ...
  <footer className="bg-black text-white mt-20"> 
    <Container className="grid grid-cols-2 gap-12 py-16 md:grid-cols-5 border-b border-gray-700">
      ...
      <div className="col-span-2 md:col-span-1">
        ...
        <p className="mt-4 text-sm text-gray-400">Get 10% off your first order</p>
        ...
        <form onSubmit={(e)=>e.preventDefault()} className="mt-4">
          <div className="relative py-2 pl-2 pr-7 rounded border border-white ">
            ...
            />
            <svg className="absolute right-3 top-1/2 -translate-y-1/2 cursor-pointer" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M22 2 11 13"/><path d="M22 2 15 22l-4-9-9-4Z"/></svg>
          </div>
        </form>
      </div>
      ...
      <div className="md:col-span-1">
        ...
        <ul className="mt-6 space-y-4 text-sm text-gray-400">
          ...
          <li><a href="tel:+88015888889999" className="hover:text-white">+999-88888-9999</a></li>
        </ul>
      </div>
      ...
      <div className="col-span-2 md:col-span-1">
        ...
        <p className="mt-6 text-xs text-gray-400">Save $3 with App New User Only</p>
        
        <div className="mt-4 flex items-center gap-2">
          <div className="bg-white p-1">
            <img width="80" height="80" src={qrcode} alt="QR Code">
            </img>
          </div>
          
          <div className="flex flex-col gap-2">
            <img alt="Google Play" className="h-8 w-auto" src={googlePlayBadge} />
