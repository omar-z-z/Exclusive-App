    ...
    <footer className="bg-black text-white mt-10">
      <Container className="grid grid-cols-3 lg:grid-cols-5 gap-4 py-6 border-b border-gray-700">
        ...
        <div className="col-span-3 lg:col-span-1">
          ...
          <p className="mt-1 text-xs lg:text-sm text-gray-400">Get 10% off your first order</p>
        ...
        <div className="col-span-1 mt-2 lg:mt-0">
          ...
          <ul className="mt-2 space-y-1 text-xs lg:text-sm text-gray-400">
            <li>Imam Ali St., Rafah,<br />Gaza, Palestine.</li>
            <li><a href="mailto:exclusive@gmail.com" className="hover:text-white">exclusive@gmail.com</a></li>
            <li><a href="tel:+999888889999" className="hover:text-white">+999-88888-9999</a></li>
          </ul>
        </div>
        ...
        <div className="justify-center col-span-3 lg:col-span-1 mt-2 lg:mt-0 flex flex-row lg:flex-col items-center gap-3 lg:gap-1">
          <div className="text-base lg:text-xl font-bold">Download App</div>
          <p className="mt-1 text-xs lg:text-sm text-gray-400">Save $3 with App New User Only</p>

          <div className="mt-1 flex flex-row items-center gap-2 lg:gap-4">
            <div className="bg-white p-1">
              <img className="w-32 h-auto sm:w-16 sm:h-16 lg:w-20 lg:h-20" src={qrcode} alt="QR Code" />
            </div>
            <div className="flex flex-col gap-1">
              <img className="h-12 w-auto sm:h-8 lg:h-10" src={googlePlayBadge} alt="Google Play" />
              <img className="h-12 w-auto sm:h-8 lg:h-10" src={appStoreBadge} alt="App Store" />
            </div>
          </div>

          <div className="mt-2 flex flex-wrap sm:flex-row gap-1 sm:gap-2">
            {[facebook, twitter, instagram, linkedin].map((icon) => (
              <img alt={icon} className="h-4 w-4 md:h-8 md:w-8" key={icon} src={icon} />
            ))}
          </div>
        </div>
      </Container>
